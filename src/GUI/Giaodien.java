...
public final class Giaodien extends javax.swing.JFrame {
    ...
    DefaultTableModel model2;//táº¡o model cho bang muon tra
    ...
    private void initComponents() {
        ...
        nÃƒÂºtuakhachmuon = new javax.swing.JButton();
      ...
      //Quáº£n lÃ½ Ä‘á»™c giáº£
        ...
        nÃƒÂºtuakhachmuon.setText("Sửa phiếu");
        nÃƒÂºtuakhachmuon.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                nÃƒÂºtuakhachmuonActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(nÃƒÂºtuakhachmuon, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(28, 28, 28)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(nÃƒÂºtuakhachmuon)
    ...
    private void nutxoakhachmuonActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	if (hangpm != -1) {
           ...
           JOptionPane.showMessageDialog(rootPane, "Bạn cần nhập thông tin cần xóa!");
        }
    }
    ...
    private void themsachActionPerformed(java.awt.event.ActionEvent evt) {          
        if (nhaptensach.getText().length() != 0) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Bạn cần nhập thông tin!");
        }
    }
    ...
    private void nutsuasachActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (hangchon != -1) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Bạn cần nhập thông tin cần sửa!");
        }
    }
    ...
    private void luusachActionPerformed(java.awt.event.ActionEvent evt) {
        if (nhaptensach.getText().length() != 0) {
            ...
            JOptionPane.showMessageDialog(rootPane, "Mời bạn nhập lại!");
        }
    }
...
//DOCGIA
    ...
    private void nÃƒÂºtuakhachmuonActionPerformed(java.awt.event.ActionEvent evt) {
        int hangpm;
    ...
    private javax.swing.JButton nÃƒÂºtuakhachmuon;
